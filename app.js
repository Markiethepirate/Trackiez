...
const translations = {
    ru: {
        ...
        howItWorks: 'КАК ЭТО РАБОТАЕТ', about: 'О ПРОЕКТЕ', contacts: 'КОНТАКТЫ', aiInfo: 'ИНФОРМАЦИЯ ДЛЯ ИИ', mainNavigation: 'Основная навигация', guideTitle: 'КАК ЭТО РАБОТАЕТ',
    ...
    en: {
        ...
        howItWorks: 'HOW IT WORKS', about: 'ABOUT', contacts: 'CONTACTS', aiInfo: 'AI INFO', mainNavigation: 'Main navigation', guideTitle: 'HOW IT WORKS',
